...
from ash_class import *
from girl_class import *
...
class App:
    def __init__(self):
        ...
        self.running = True
        self.state = 'start'
        self.cell_width = MAPA_WIDTH//COLS
        self.cell_height = MAPA_HEIGHT//ROWS
        self.walls = []
        self.coins = []
        self.enemies = []
        self.e_pos = []
        self.p_pos = None
        self.load()
        self.player = Ash(self, vec(self.p_pos))
        self.make_enemies()
    ...
    def load(self):
        ...
        self.background = pygame.transform.scale(self.background, (MAPA_WIDTH, MAPA_HEIGHT))
    ...
    def game_over_draw(self):
        ...
        self.draw_text("GAME OVER", self.screen, [WIDTH//2, 100],  52, (208, 22, 22), "arial", centered=True)
